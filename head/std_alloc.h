...
#include<iostream>
#define __THROW_BAD_ALLOC std::cerr << "out of memory" << std::end; exit(1);
#endif
...
class __default_alloc__template {
private:
...
template<bool threads, int inst>
char* __default_alloc__template<threads, inst>::start_free = 0;

template<bool threads, int inst>
char* __default_alloc__template<threads, inst>::end_free = 0;

template<bool threads, int inst>
size_t __default_alloc__template<threads, inst>::heap_size = 0;

template<bool threads, int inst>
typename __default_alloc__template<threads, inst>::obj* volatile 
__default_alloc__template<threads, inst>::free_list[__NFREELISTS] = {
...
template<bool threads, int inst>
char *
__default_alloc__template<threads, inst>::chunk_alloc(size_t size, int& nobjs)
{
	char* result;
